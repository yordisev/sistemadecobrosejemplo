! function(a) {
    a.fn.smkValidate = function() {
        ...
        return d.each(function(d, e) {
            ...
            if ("undefined" == typeof r && (r = "."), "undefined" == typeof s && (s = ","), a.smkRemoveError(f), ("radio" === g || "checkbox" === g) && (i = a("input[name='" + j + "']:checked").val()), "required" !== k || "" !== i && void 0 !== i || (c = a.smkAddError(f, b.textEmpty)), "" !== i) {
                ...
                if ("number" === g || "number" === h) {
                    ...
                    } else c = a.smkAddError(f, b.textNumber)
                }
                if ("decimal" === h) {
                ...
                if ("password" === g) {
                    ...
                    switch (p) {
                        ...
                        case "strong":
                            ...
                            break;
                        default:
                            D = /^(?=.*[a-z0-9])\w{4,}$/, E = b.textSPassDefault
                    }
            ...
            f.off(".validation").on("keyup.validation change.validation click.validation", function() { a(this).smkValidate() })
        }), this.find(".form-group.has-feedback.has-error").first().find(":input:not(:button):not(:disabled):not(.novalidate)").first().focus(), c
    }, a.smkEqualPass = function(b, c) { var d = a.smkEqualPass.Languaje; return void 0 === d && (d = { textEqualPass: "Passwords do not match" }), b = void 0 !== a(b).val() ? a(b).val() : b, b !== a(c).val() ? a.smkAddError(a(c), d.textEqualPass) : !0 }, a.fn.smkClear = function() {
    ...
    }, a.smkRemoveError = function(b) { var c = a(b).parents(".form-group"); return c.find(".smk-error-msg, .smk-error-icon").remove(), c.removeClass("has-error has-feedback"), !1 }, a.smokeCustomizeMsg = function(b, c) {
        var d = "";
        if ("string" == typeof c) d = b.replace("{@}", c);
        else {
            var e = b.split("{@}");
            a.each(c, function(a, b) { d += e[a] + b }), d += e[e.length - 1]
        }
        return d
    }, a.smkAlert = function(b) {
        function c() { h = setTimeout(function() { g.animate({ opacity: "0" }, 300, function() { g.remove() }) }, 1e3 * d.time) }
        var d = a.extend({ text: "Hola Mundo", type: "warning", icon: "", position: "top-right", time: 5, permanent: !1 }, b),
            e = "smk-alert-content",
        ...
        if (a("." + e).prepend(g), g.animate({ opacity: "1" }, 300), d.permanent === !1) {
            var h = 0;
            a(g).mouseenter(function() { clearTimeout(h) }).mouseleave(function() { c() }), c()
        }
    }, a.smkConfirm = function(b, c) {
        function d() { a(".smk-confirm-back").fadeOut(200, function() { a(".smk-confirm-back").remove() }), a(".smk-confirm").animate({ top: "-500px", opacity: "0" }, 400, function() { a(".smk-confirm").remove() }) }
        var e = a.extend({ text: "are you sure?", accept: "Accept", cancel: "Cancel" }, b);
        a("body").append('<div class="smk-confirm-back"><div class="panel panel-default smk-confirm" tabindex="1"><div class="panel-body">' + e.text + '</div><div class="panel-footer text-right"><a class="btn btn-default btn-sm smk-cancel" href="#" >' + e.cancel + '</a> <a class="btn btn-primary btn-sm smk-accept" href="#">' + e.accept + "</a></div></div></div>"), a(".smk-confirm").animate({ top: "-5px", opacity: "1" }, 400, function() { a(".smk-confirm").focus() }).on("keydown", function(b) { 27 === b.which ? a(".smk-cancel").click() : 13 === b.which && (a(".smk-accept").is(":focus") || a(".smk-accept").click()) }), a(".smk-cancel").click(function(a) { a.preventDefault(), d(), c(!1) }), a(".smk-accept").click(function(a) { a.preventDefault(), d(), c(!0) })
    }, a.smkPrompt = function(b, c) {
        function d() { a(".smk-confirm-back").fadeOut(200, function() { a(".smk-confirm-back").remove() }), a(".smk-prompt").animate({ top: "-500px", opacity: "0" }, 400, function() { a(".smk-prompt").remove() }) }
        var e = a.extend({ text: "Enter value", defaultValue: "", accept: "Accept", cancel: "Cancel" }, b);
    ...
    }, a.smkFloat = function(a) { return "string" == typeof a && (a = a.replace(",", "")), parseFloat(a) }, a.smkCurrency = function(a, b) {
        ...
        var d = c.split("."),
            ...
            f = d.length > 1 ? "." + d[1] : ".00";
        f += "00", f = f.substr(0, 3);
        for (var g = /(\d+)(\d{3})/; g.test(e);) e = e.replace(g, "$1,$2");
        return b + e + f
        ...
        c.addClass("smk-show-pass"), c.append(d), c.find(".smk-btn-show-pass").click(function(c) { c.preventDefault(), "password" == b.prop("type") ? (b.prop("type", "text"), a(this).addClass("glyphicon-eye-close"), a(this).removeClass("glyphicon-eye-open")) : (b.prop("type", "password"), a(this).removeClass("glyphicon-eye-close"), a(this).addClass("glyphicon-eye-open")) })
    }, a.smkHideEmail = function(a) { for (var b = a.split("@"), c = b[0].charAt(0), d = b[0].slice(-1), e = "", f = 0; f < b[0].length - 2; f++) e += "*"; var g = c + e + d + "@" + b[1]; return g }, a.smkDatePicker = function(a) {
        if ("" !== a) {
        ...
        var c = a.smkDatePicker(new Date),
            d = a.extend({ date: c, format: "yyyy-mm-dd" }, a.smkDate.Languaje, b),
            e = a.smkDate.Languaje;
        void 0 === e && (e = { shortMonthNames: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], monthNames: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"] });
        var f = /\d+|[a-zA-z]/g,
        ...
        if ("Invalid Date" != d.date) {
            var i = { d: d.date.getDate(), dd: (d.date.getDate() < 10 ? "0" : "") + d.date.getDate(), m: d.date.getMonth() + 1, mm: (d.date.getMonth() + 1 < 10 ? "0" : "") + (d.date.getMonth() + 1), M: e.shortMonthNames[d.date.getMonth()], MM: e.monthNames[d.date.getMonth()], yyyy: d.date.getFullYear(), yy: d.date.getFullYear().toString().substring(2), hh: d.date.getHours(), mi: d.date.getMinutes(), ss: d.date.getSeconds() },
                j = /dd?|DD?|mm?|MM?|yy(?:yy)?/g,
                k = d.format.replace(j, "\x00").split("\x00"),
                l = d.format.match(j);
            a.each(l, function(a, b) { h += k[a] + i[b] })
        } else h = "", console.log("Invalid Date");
        return h
    }, a.smkDateDiff = function(b) {
        var c = a.extend({ fromDate: new Date, toDate: new Date, interval: "days" }, b),
            d = 1e3,
            e = 60 * d,
            f = 60 * e,
            g = 24 * f,
        ...
        var c = a.extend({ speed: 1e3 }, b);
        a("a[href*=#]:not([href=#])").click(function() { if (location.pathname.replace(/^\//, "") == this.pathname.replace(/^\//, "") && location.hostname == this.hostname) { var b = a(this.hash); if (b = b.length ? b : a("[name=" + this.hash.slice(1) + "]"), b.length) return a("html,body").animate({ scrollTop: b.offset().top }, c.speed), !1 } })
    }, a.smkProgressBar = function(b) {
        var c = a.extend({ element: "body", status: "start", bgColor: "#fff", barColor: "", content: "" }, b);
        if ("start" == c.status) {
        ...
        } else "end" == c.status && a(c.element + " .smk-progressbar .progress .progress-bar").width("110%").delay(200, function() { a(c.element + " .smk-progressbar").fadeOut("slow", function() { a(this).remove() }) })
        ...
        a(this).append(c), a(".smk-fullscreen").click(function(a) { a.preventDefault(), b() });
        var d = function() { a(".smk-fullscreen").children(".glyphicon").toggleClass("glyphicon-fullscreen").toggleClass("glyphicon-resize-small") };
        ...
        var c = a.extend({ hide: "" }, b),
            d = a(this),
            e = c.hide.replace(/\s/g, ""),
            f = e.split(","),
            g = a(this).children(".panel-heading");
        g.length || (g = a("<div>", { "class": "panel-heading" }), a(this).prepend(g));
        var h = g.children(".panel-title");
        g.addClass("clearfix"), h.length && h.addClass("pull-left");
        var i = '<div class="btn-group btn-group-xs pull-right" role="group">'; - 1 == a.inArray("min", f) && (i += '<a class="btn smk-min" href="#"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span></a>'), -1 == a.inArray("remove", f) && (i += '<a class="btn smk-remove" href="#"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a>'), -1 == a.inArray("full", f) && (i += '<a class="btn smk-full" href="#"><span class="glyphicon glyphicon-resize-full" aria-hidden="true"></span></a>'), i += "</div>", a(this).children(".panel-heading").append(i), d.find(".smk-min").click(function(b) {
            b.preventDefault();
            ...
            a(d).slideToggle("fast"), a(c).slideToggle("fast", function() { e.toggleClass("glyphicon-minus").toggleClass("glyphicon-plus") })
            ...
            c.hasClass("panel-full") ? (c.removeClass("panel-full"), a(this).siblings(".btn").show(), 1 == f.length && d.hide(), a("body").css({ overflow: "auto" })) : (c.addClass("panel-full"), a(this).siblings(".btn").hide(), 1 == f.length && d.show(), a("body").css({ overflow: "hidden" })), e.toggleClass("glyphicon-resize-full").toggleClass("glyphicon-resize-small")
        })
    }
}(jQuery);